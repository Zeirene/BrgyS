...
Public Class ApiClient
    ...
    Private ReadOnly apiUrl2 As String = "https://yjme796l3k.execute-api.ap-southeast-2.amazonaws.com/dev/api/v1/brgy/residents/personal_records"
    ...
    Public Async Function GetTransactionRecordsAsync() As Task(Of List(Of ApiResponse.ResidentRecord))
        Using client As New HttpClient()
            ' Set headers (if required)
            client.DefaultRequestHeaders.Accept.Add(New MediaTypeWithQualityHeaderValue("application/json"))
