    ...
    Public Sub Sitiodata()
        ...
        Select Case Guna2ComboBox3.SelectedItem.ToString
            Case "Sitio 1"
                ...
                Guna2ComboBox3.Items.Add("Paguio")
                Guna2ComboBox3.Items.Add("Endraca Compound")
                Guna2ComboBox3.Items.Add("Cursilista")
                Guna2ComboBox3.Items.Add("Pamana")
                Guna2ComboBox3.Items.Add("Castro Compound")
                Guna2ComboBox3.Items.Add("Sta. Marcela")
                Guna2ComboBox3.Items.Add("Galvez Compound")
                Guna2ComboBox3.Items.Add("Rivera Compound")
                Guna2ComboBox3.Items.Add("Amity Ville")
                Guna2ComboBox3.Items.Add("Plain Ville")
